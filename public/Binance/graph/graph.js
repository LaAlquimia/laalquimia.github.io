...
const graph = async (series, symbol, emaSeries, volumeSeries) => {
  ...
  const ema = EMA(numericValues.reverse(), 59).reverse();
  console.log("ema:", ema);
  ...
  // Log de los datos antes de asignarlos al chart
  console.log("symbol:", symbol);
  console.log("emaDist:", emaDist);
  console.log("emaData:", emaData);
  console.log("volumeData:", volumeData);
  console.log("umbdata:", umbdata);
  console.log("umbdata2:", umbdata2);
  console.log("datosConv1:", datosConv1);
